...
Journal Papers
======
* **X. Jian**, M. Gölz, F. Ji, W. P. Tay, A. Zoubir, “A Generalized Graph Signal Processing Framework for Multiple Hypothesis Testing over Networks,” in _IEEE Transactions on Signal Processing_, vol. 73, pp. 3496-3512, 2025. [(Online)](https://ieeexplore.ieee.org/document/11099058)[(Code)](https://github.com/xcjian/GGSP-detection)
...
======
* **X. Jian**, P. Zhang, T. Lan, F. Ji, W. Liang, W. P. Tay, B. Wen, and F. Krahmer, “Conformal prediction for multi-source detection on a network,” in _Proc. AAAI Conference on Artificial Intelligence_, Singapore, Jan. 2026. [(Online)](https://arxiv.org/abs/2511.08867)[(Code)](https://github.com/xcjian/Conformalized-Network-Source-Detection)
